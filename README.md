...
| `--hemisphere-seam-residual-degrees` | `2` | 仅无 A1 RGB 硬拼：校正赤道异常梯度的半宽；设为 `0` 关闭 |
| `--hemisphere-seam-residual-blur-degrees` | `0.5` | 赤道残差沿经度环形平滑的角尺度 |
...
python telestylepanorama_inference.py \
    ...
    --hemisphere-size 1024 \
    --hemisphere-overlap-degrees 15 \
    --hemisphere-color-match-degrees 6 \
    --hemisphere-seam-residual-degrees 2 \
    --hemisphere-seam-residual-blur-degrees 0.5 \
    --steps 4 \
    --seed 123 \
